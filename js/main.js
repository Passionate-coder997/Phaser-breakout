...
function create() {
    ...
    for (var y = 0; y < 5; y++) {
        for (var x = 0; x < 15; x++) {
            brick = bricks.create(2 + (x * 150), 85 + (y * 50), 'brick');
    ...
    paddle.anchor.set(0.5, -5);
    paddle.body.immovable = true;

    //create the ball
    ball = game.add.sprite(game.world.centerX, paddle.y - 40, 'ball');
    ...
    introText = game.add.text(game.world.centerX, 400, '- click to start -', { font: "40px Arial", fill: "#A9A9A9", align: "center" });
